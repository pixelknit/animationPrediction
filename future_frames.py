...
from transformer_model import TransformerEncoder, positional_encoding, create_transformer_model
...
num_predictions = 10
#model = create_transformer_model(sequence_length, num_bones, features_per_bone, num_future_frames=num_predictions)
...
input_sequence = X[-1:]  # Use the last available sequence as input
predicted_frames = []
